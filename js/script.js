...
,
	...
	{
		"title":"William Jackson 'Corey Haim' Boss Battle/Fight Music Theme",
		"artist":"South Park",
...
$( document ).ready(function() {
    ...
    $("#b").append("<div class='c'>" + "<p>" + "Song Title: " + title + "</p>" + "Author: " + artist + "<p>" + "Song Link: " + mp3Url + "</p>" + "<p>" + "<img id=" + title + " class='y' src=" + imageUrl + ">" + "</p>" + "<p>"+ "Length: " + songLength + "</p>" +  "</div>");
    // $("#b").find(title);
    $("body").append("<audio src=" + mp3Link + "autoplay=autoplay loop=loop></audio>");
